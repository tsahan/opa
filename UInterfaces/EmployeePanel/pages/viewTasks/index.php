    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" <a="" href="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/viewtasks/?id=<?php echo $_SESSION['sess_user_id'];?>	"><img src="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/logo1.png" alt="Mountain View" style="width:;height:;"><p></p>
</a>
...
<!------------------------- Display comments--------------------------->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/viewtasks/index.php?id=<?php echo $_SESSION['sess_user_id'];?>"><i class="fa fa-calendar fa-fw"></i> Calendar</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-tasks fa-fw"></i> Tasks<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/viewtasks/viewtasks.php?id=<?php echo $_SESSION['sess_user_id'];?>">View Tasks</a>
                                </li>
                                
								<li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/SubmitTasks/SubmitTasks.php?id=<?php echo $_SESSION['sess_user_id'];?>">Submit Tasks </a>
                                </li>
                        ...
                        <li>
							...
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/ViewEvents/viewEvents.php?id=<?php echo $_SESSION['sess_user_id'];?>">View Events</a>
                                </li>
                        ...
                        <li>
							...
							<ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/ViewMeetings/ViewMeetings.php?id=<?php echo $_SESSION['sess_user_id'];?>">View Meetings</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/charts/taskProgression.php?id=<?php echo $_SESSION['sess_user_id'];?>">Task Progressions</a>
                                </li>
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/charts/donevsProg.php?id=<?php echo $_SESSION['sess_user_id'];?>">Done vs. In Progress</a>
                                </li>
								    </ul>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">My Calendar<img src="http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/viewtasks/key.png" alt="Mountain View" style="width:;height:;"></h1> 
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
