...
<!------------------------- Display comments--------------------------->
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Add your Comment</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
				...
				<html>
							...
							<?php
								...
								*/
								 ...
								 function renderForm($taskID, $title)
								 {
								 ?>
					...
					<div class="form-group">
                                      ...
                                      <div class="col-sm-10">
										<textarea rows="4" cols="50" id="desription" name="description"class="form-task " style="margin: 0px; width: 100%; height: 220px;" > </textarea>
					 ...
					 $old  = $row['comments'];
						...
						$old.=$description;
						 ...
						 // check that firstname/lastname fields are both filled in
										 ...
										 mysql_query("UPDATE task SET comments='$old' , checkedDate = '$result'  WHERE taskID='$taskID'")
										 or die(mysql_error()); 
										 
										 // once saved, redirect back to the view page
											echo("<script>location.href = 'http://localhost/CompanyCalendar/UInterfaces/EmployeePanel/pages/SubmitTasks/SubmitTasks.php?id=Amine';</script>");
