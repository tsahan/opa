...
*/
        /*** prepare the insert ***/
        $stmt = $dbh->prepare("INSERT INTO meetings (meetingsTitle, meetingsDetails , meetingsDate , meetingsTime , users,duration ) VALUES (:meetingsTitle, :meetingsDetails, :meetingsDate, :meetingsTime, :users,:duration )");
