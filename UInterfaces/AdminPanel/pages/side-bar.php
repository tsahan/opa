                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/AdminPanel/pages/addtasks/addtasks.php">Assign Tasks</a>
                                </li>
								<li>
                        ...
                        <li>
                            <a href="tables.html"><i class="fa fa-comments fa-fw"></i> Teams<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/AdminPanel/pages/project/viewProject.php">View Projects</a>
                                </li>
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/AdminPanel/pages/project/addProject.php">Add Project</a>
                                </li>
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/AdminPanel/pages/project/editProject.php">Edit Project</a>
                                </li>
                                <li>
                                    <a href="http://localhost/CompanyCalendar/UInterfaces/AdminPanel/pages/project/addTask.php">Add Task</a>
                                </li>
