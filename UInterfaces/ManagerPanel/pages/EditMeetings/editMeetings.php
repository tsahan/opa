            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
							...
							*/
								...
								$result = mysql_query("SELECT * FROM meetings WHERE meetingsRespo LIKE '%$myID%'") 
									or die(mysql_error());  
								...
								while($row = mysql_fetch_array( $result )) {
									...
									echo '<td><a href="edit.php?meetingsID=' . $row['meetingsID'] . '">Edit</a></td>';
									echo '<td><a href="delete.php?meetingsID=' . $row['meetingsID'] . '">Delete</a></td>';
