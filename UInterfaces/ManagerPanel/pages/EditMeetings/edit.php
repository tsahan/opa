    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Edit Meetings</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
				...
				<html>
							...
							<?php
								...
								*/
								 ...
								 function renderForm($meetingsID, $meetingsTitle, $meetingsDetails,$meetingsDate,$meetingsTime,$duration,$users)
								 {
								 ?>
								 ...
								 <input type="hidden" name="meetingsID" value="<?php echo $meetingsID; ?>"/>
								 <div>
								 <p><strong>ID:</strong> <?php echo $meetingsID; ?></p>
							  ...
							  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" id="meetingsTitle" name="meetingsTitle" value="<?php echo $meetingsTitle;?>" maxlength="100"  class="form-control">
					...
					<div class="form-group">
                                      ...
                                      <div class="col-sm-10">
										<textarea rows="4" cols="50" id="meetingsDetails" name="meetingsDetails"class="form-task " style="margin: 0px; width: 100%; height: 139px;" ><?php echo $meetingsDetails;?>" </textarea>
					...
					<div class="form-group">
					 ...
					 <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="Time" id="duration" name="duration" value="<?php echo $duration;?>" maxlength="200"  class="form-control">
                                          <span class="help-block"></span>
                                      </div>
                    <div class="form-group">
					 ...
					 // confirm that the 'id' value is a valid integer before getting the form data
						 if (is_numeric($_POST['meetingsID']))
						 {
						 // get form data, making sure it is valid
						 $meetingsID = $_POST['meetingsID'];
						 $meetingsTitle = mysql_real_escape_string(htmlspecialchars($_POST['meetingsTitle']));
						 
						 $meetingsDetails = mysql_real_escape_string(htmlspecialchars($_POST['meetingsDetails']));
						 $meetingsDate = mysql_real_escape_string(htmlspecialchars($_POST['meetingsDate']));
						 $meetingsTime = mysql_real_escape_string(htmlspecialchars($_POST['meetingsTime']));
						 ...
						 // check that firstname/lastname fields are both filled in
								 if ($meetingsTitle == '' || $meetingsDetails == ''||$meetingsDate == '' || $meetingsTime == ''||$duration == '' || $users == '')
								 {
										 // generate error message
										 $error = 'ERROR: Please fill in all required fields!';
										 
										 //error, display form
										 renderForm($meetingsID, $meetingsTitle, $meetingsDetails,$meetingsDate ,$meetingsTime,$duration,$users);
										 }
								 else
								 {
										 // save the data to the database
										 mysql_query("UPDATE meetings SET meetingsTitle='$meetingsTitle', meetingsDetails='$meetingsDetails' , meetingsDate ='$meetingsDate', meetingsDate='$meetingsDate', duration='$duration', users='$users' WHERE meetingsID='$meetingsID'")
										 or die(mysql_error()); 
					 ...
					 if (isset($_GET['meetingsID']) && is_numeric($_GET['meetingsID']) && $_GET['meetingsID'] > 0)
					 {
					 // query db
					 $meetingsID = $_GET['meetingsID'];
					 $result = mysql_query("SELECT * FROM meetings WHERE meetingsID=$meetingsID")
					 or die(mysql_error()); 
					 ...
					 // get data from db
					 $meetingsTitle = $row['meetingsTitle'];
					 
					 $meetingsDetails = $row['meetingsDetails'];
					 $meetingsDate = $row['meetingsDate'];
					 $meetingsTime = $row['meetingsTime'];
