            ...
            <div class="container-fluid">
                ...
                <!-- /.row -->
							...
							*/
								...
								$result = mysql_query("SELECT * FROM task WHERE manager ='$id'") 
									or die(mysql_error());  
								...
								while($row = mysql_fetch_array( $result )) {
									...
									echo '<td><a href="edit.php?id=' . $row['taskID'] . '">Edit</a></td>';
									echo '<td><a href="delete.php?id=' . $row['taskID'] . '">Delete</a></td>';
